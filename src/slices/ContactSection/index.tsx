      ...
      <div className={styles.card} ref={cardRef}>
        ...
        <div className={styles.info}>
          ...
          {slice.primary.doctoralia_link && (
            <a
              href={
                (slice.primary.doctoralia_link as { url?: string }).url ||
                "https://www.doctoralia.es/clinicas/multifido-fisioterapia-y-readaptacion?saasonly=true&utm_id=48774&utm_source=widget-facility-48774&utm_medium=facility-big&utm_campaign=&utm_content=#highlight-calendar"
              }
              target="_blank"
