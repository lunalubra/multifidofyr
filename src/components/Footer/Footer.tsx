      ...
      <Container>
        ...
        <div className={styles.grid}>
          <div className={styles.brand}>
            <span className={styles.logo}>Multífido</span>
            <p className={styles.description}>
              Clínica de fisioterapia y readaptación deportiva en Leganés,
              Madrid. Especialistas en prevención y rehabilitación de lesiones.
            </p>
          </div>
          ...
          <div className={styles.column}>
            ...
            <p className={styles.hours}>Sáb: 09:00&ndash;13:00</p>
          ...
          <div className={styles.column}>
            <h3 className={styles.columnTitle}>Encuéntranos</h3>
            ...
            <div className={styles.social}>
              <a
                ...
                aria-label="Instagram de Multífido"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                className={styles.socialLink}
                aria-label="WhatsApp de Multífido"
              >
        ...
        <div className={styles.bottom}>
          <p className={styles.copyright}>
            &copy; 2026 Multífido Fisioterapia &amp; Readaptación. Todos los derechos reservados.
          </p>
          <div className={styles.legal}>
            <Link href="/politica-de-privacidad" className={styles.legalLink}>Política de Privacidad</Link>
